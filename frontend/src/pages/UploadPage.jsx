        ...
        return (
                <section className="card">
                        <header className="card__header">
                                <h2>agent_core: Video Processing</h2>
                                <p>Strategic orchestrator processing raw footage into platform-ready shorts.</p>
                        </header>
                        ...
                        {isBusy ? <DotLoader label="agent_core processing video" /> : null}
